...
public class MedicineRestController {
    ...
    @PostMapping("/create")
    public ResponseEntity<Medicine> create(@Valid @RequestBody Medicine medicine, BindingResult bindingResult)
    ...
    @PutMapping("/update")
    public ResponseEntity<Medicine> update(@Valid @RequestBody Medicine medicine, BindingResult bindingResult)
            throws ModelNotVaildException {
        if (bindingResult.hasErrors())
            throw ModelNotVaildException.fromBindingResult(bindingResult);
