...
<body>
						...
						<form onsubmit="return false" name="doctor-form">
							<div class="col">
								...
								<div class="item">
									...
									<input type="text" name="doctorName" id="doctorName" class="input text-input"
										placeholder="Eg: John Doe" value="${doctor.name}" disabled>
									<label for="doctorName" class="error-msg text-danger" id="name-error"></label>
								</div>
								<div class="item">
							...
							<form id="patient-form" name="patient-form" autocomplete="off">
								<div class="col">
									...
									<div class="item">
										...
										<input type="text" name="patientName" id="patientName" class="input text-input"
											placeholder="Eg: John Doe" disabled value="${patient.name}">
										<label for="patientName" class="error-msg text-danger" id="name-error"></label>
									</div>
									<div class="item">
										<label for="patientGender" class="text-label">Gender</label>
										<select name="patientGender" class="input" disabled>
											<option value="true" ${ patient.gender==true ? 'selected' :'' }>Female
											</option>
											<option value="false" ${ patient.gender==false ? 'selected' :'' }>Male
											</option>
								...
								<div class="col">
									<div class="item">
										...
										<input type="date" name="patientDateOfBirth" id="birth" class="input text-input"
								...
								<div class="col">
									<div class="item">
										...
										<input type="text" name="patientAddress" id="patientAddress"
											class="input text-input" placeholder="Eg: Ho Chi Minh city, Viet Nam"
											disabled value="${patient.address}" />
							...
							<form id="health-record-form" name="health-record-form" autocomplete="off">
								<div class="col">
									<div class="item">
										...
										<fmt:formatDate pattern="yyyy-MM-dd" value="${healthRecord.creationDate}"
											var="formatDay" />
									...
									<div class="item">
										...
										<input type="date" name="reDate" id="reDate" class="input text-input"
											value="${ formatDay }">
										<label for="reDate" class="error-msg text-danger" id="reDate-error"></label>
									</div>
								</div>
							</form>
						</div>
							...
							<table class="table table-striped p-3" id="health-record-detail-table">
								...
								<tbody id="tbody-list-illness">
									...
									<c:if test="${empty illnessList}">
										<tr class="nothing">
											<td class="text-center" colspan="3">Nothings to show</td>
										</tr>
									</c:if>
					...
					<div id="prescription-detail">
						<div class="health-record-head">
							<div class="sub-title-container d-flex justify-content-between mb-3">
								...
								<button type="button" class="btn btn-primary" id="btn-prescription-detail">ADD</button>
							</div>
						</div>
						<table class="table table-striped p-3" id="prescription-detail-table">
							...
							<tbody id="list-prescription-detail">
								<c:set var="healthRecordDetails" value="${healthRecord.healthRecordDetails}"></c:set>
									...
									<c:forEach var="detail" items="${healthRecordDetails}">
										<tr>
											...
											<td id="prescription-data">
												<input type="hidden" id="prescription-id" value="${detail.id}">
												<input type="hidden" id="medicine-id" value="${detail.medicine.id}">
												<input class="input text-input" type="number" id="quantity" min="0"
													value="${detail.quantity}">
											</td>
											<td>${detail.medicine.unit}</td>
											<td>
												<button type="button" class="btn-health-record-detail-remove">
													<i class="fa fa-times" aria-hidden="true"></i>
												</button>
											</td>
										</tr>
	...
	<div class="modal fade" id="searchPatientModel" tabindex="-1" role="dialog" aria-labelledby="searchPatientModel"
		aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
	...
	<div class="modal fade" id="searchDoctorModel" tabindex="-1" role="dialog" aria-labelledby="searchDoctorModel"
		aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<form name="doctor-filter" onsubmit="return false;">
						<div class="col p-0">
							<input type="text" name="name" id="doctorName" class="input text-input"
								placeholder="Eg: John Doe">
							<button class="btn btn-primary" type="button" id="btn-doctor-search"><i class="fa fa-search"
									aria-hidden="true"></i>
							</button>
						</div>
					</form>
	...
	<div class="modal fade" id="searchIllnessModel" tabindex="-1" role="dialog" aria-labelledby="searchIllnessModel"
		aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
	...
	<div class="modal fade" id="searchMedicineModel" tabindex="-1" role="dialog" aria-labelledby="searchMedicineModel"
		aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
