...
<head>
    ...
    <title>Department Form List</title>
...
<div class="container">
    ...
    <div class="table-container-outside">
        <div class="title-table">List Department</div>
        <div class="d-flex justify-content-end">
            <a href="/department/create" class="btn btn-success" id="create-button">
        ...
        <nav aria-label="Page navigation example" class="mt-3 d=flex">
            ...
            <ul class="pagination justify-content-end ali">
                ...
                <c:if test="${ currentPage > 1 }">
                    <li class="page-item"><a class="page-link" href="/department/list?page=${ currentPage - 1 }"
                                             aria-label="Previous">
                ...
                <c:forEach var="pageNumber" begin="${ currentPage }" end="${ end }">
                    <li class="page-item"><a class="page-link" href="/department/list?page=${pageNumber}">${
                            pageNumber }</a></li>
                </c:forEach>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="deleteDepartment();">Delete</button>
            </div>
        </div>
    </div>
</div>
