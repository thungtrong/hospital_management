	...
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
			...
			<body>
									...
									<form id="test-form" name="test-form" autocomplete="off">
										...
										<div class="col">
											...
											<div class="item">
												...
												<label for="gender" class="error-msg text-danger"
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="exampleModalLabel">Update Test Form</h5>
							...
							<div class="modal-footer">
								...
								<button type="button" class="btn btn-primary" onclick="goToTestFormList();">Back to
									list</button>
							</div>
						</div>
					</div>
				...
				<div class="modal fade" id="searchTestModel" tabindex="-1" role="dialog"
					aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
							...
							<div class="modal-body">
								<form name="test-filter">
									<div class="col p-0">
										...
										<button class="btn btn-primary" type="button" id="btn-test-search"><i
												class="fa fa-search" aria-hidden="true"></i>
										</button>
									</div>
								</form>
				...
				<!-- Javascript -->
				<script type="text/javascript" src="/js/test-form/update-test-form.js"></script>
			</body>
