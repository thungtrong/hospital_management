										...
										<div class="col">
											<div class="item">
												...
												<input type="date" name="dateOfBirth" id="birth"
													class="input text-input" placeholder="Eg: 22/7/1990"
													value="${ patient.dateOfBirth }" disabled>
										...
										<div class="col">
											<div class="item">
												...
												<input type="text" name="address" id="address" class="input text-input"
													placeholder="Eg: Ho Chi Minh city, Viet Nam"
											...
											<div class="item">
												...
												<input type="date" name="creationDate" id="creationDate"
													class="input text-input" value="${ formatDay }" disabled>
