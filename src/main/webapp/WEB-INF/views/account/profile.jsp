                            ...
                            <div class="col">
                                ...
                                <div class="item">
                                    ...
                                    <select name="gender" class="input">
                                        <option value="true" ${ doctor.gender==true ? 'selected' :'' }>Female</option>
                                        <option value="false" ${ doctor.gender==false ? 'selected' :'' }>Male</option>
                                    </select>
                            ...
                            <div class="col">
                                <div class="item">
                                    ...
                                    <input type="date" name="dateOfBirth" id="birth" class="input text-input"
                                        placeholder="Eg: 22/7/1990" value="${ doctor.dateOfBirth }">
                                ...
                                <div class="item">
                                    ...
                                    <input type="text" name="phoneNumber" id="phoneNumber" class="input text-input"
                                        placeholder="Eg: 0918464495" value="${ doctor.phoneNumber }">
                            ...
                            <div class="col">
                                <div class="item">
                                    ...
                                    <input type="text" name="address" id="address" class="input text-input"
                                        placeholder="" value="${ doctor.address }">
