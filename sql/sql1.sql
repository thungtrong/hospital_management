...
Insert into VN_JAVA2.DOCTOR (ID,ADDRESS,DATE_OF_BIRTH,GENDER,NAME,PHONE_NUMBER,DEPARTMENT_ID) values ((VN_JAVA2.seq_doctor_pk.nextval),'Clark County, Idaho, United States',to_date('11-NOV-80','DD-MON-RR'),0,'Dick Bradley Clayton','0987654321',null);
Insert into VN_JAVA2.DOCTOR (ID,ADDRESS,DATE_OF_BIRTH,GENDER,NAME,PHONE_NUMBER,DEPARTMENT_ID) values ((VN_JAVA2.seq_doctor_pk.nextval),' Moonachie Avenue, Moonachie, Bergen County, New Jersey, 07074, United States',to_date('31-DEC-80','DD-MON-RR'),1,'Christa Hand','0987654316',null);
Insert into VN_JAVA2.DOCTOR (ID,ADDRESS,DATE_OF_BIRTH,GENDER,NAME,PHONE_NUMBER,DEPARTMENT_ID) values ((VN_JAVA2.seq_doctor_pk.nextval),' Limones, Yabucoa, Puerto Rico, 00767, United States',to_date('12-DEC-70','DD-MON-RR'),0,'Kenneth Martin Valenzuela','4649921169',null);
Insert into VN_JAVA2.DOCTOR (ID,ADDRESS,DATE_OF_BIRTH,GENDER,NAME,PHONE_NUMBER,DEPARTMENT_ID) values ((VN_JAVA2.seq_doctor_pk.nextval),'Wilmington Island, Chatham County, Georgia, 31410, United States',to_date('21-MAR-50','DD-MON-RR'),0,'Luke Wallace Werner','0987654632',null);
Insert into VN_JAVA2.DOCTOR (ID,ADDRESS,DATE_OF_BIRTH,GENDER,NAME,PHONE_NUMBER,DEPARTMENT_ID) values ((VN_JAVA2.seq_doctor_pk.nextval),'Buckhorn Road, Au Train Township, Alger County, Michigan, United States',to_date('07-MAY-62','DD-MON-RR'),0,'Dan Charles Benjamin','0987654324',null);
...
Insert into VN_JAVA2.DOCTOR (ID,ADDRESS,DATE_OF_BIRTH,GENDER,NAME,PHONE_NUMBER,DEPARTMENT_ID) values ((VN_JAVA2.seq_doctor_pk.nextval),' Tierras Nuevas Poniente, Manatí, Puerto Rico, 00701, United States',to_date('14-SEP-75','DD-MON-RR'),0,'Leigh Mindy Shultz','4642345337',null);
Insert into VN_JAVA2.DOCTOR (ID,ADDRESS,DATE_OF_BIRTH,GENDER,NAME,PHONE_NUMBER,DEPARTMENT_ID) values ((VN_JAVA2.seq_doctor_pk.nextval),'Ray''s Campground, Sunday Road, Hico, Fayette County, West Virginia, 25854, United States',to_date('12-DEC-90','DD-MON-RR'),0,'Ted Devin Schneider','4642336337',null);
Insert into VN_JAVA2.DOCTOR (ID,ADDRESS,DATE_OF_BIRTH,GENDER,NAME,PHONE_NUMBER,DEPARTMENT_ID) values ((VN_JAVA2.seq_doctor_pk.nextval),'Woodrow Wilson Bridge, National Harbor, Prince George''s County, Maryland, 23242, United States',to_date('09-NOV-70','DD-MON-RR'),0,'Armando Smith','3698970311',null);
Insert into VN_JAVA2.DOCTOR (ID,ADDRESS,DATE_OF_BIRTH,GENDER,NAME,PHONE_NUMBER,DEPARTMENT_ID) values ((VN_JAVA2.seq_doctor_pk.nextval),'247, Cole Hill Road, Standish, Cumberland County, Maine, 04084, United States',to_date('03-MAR-94','DD-MON-RR'),1,'Naomi Garner','7860281026',null);
Insert into VN_JAVA2.DOCTOR (ID,ADDRESS,DATE_OF_BIRTH,GENDER,NAME,PHONE_NUMBER,DEPARTMENT_ID) values ((VN_JAVA2.seq_doctor_pk.nextval),'Town of Riverhead, Suffolk County, New York, United States',to_date('01-JAN-76','DD-MON-RR'),0,'Rebbecca Hughs','9407794231',null);
Insert into VN_JAVA2.DOCTOR (ID,ADDRESS,DATE_OF_BIRTH,GENDER,NAME,PHONE_NUMBER,DEPARTMENT_ID) values ((VN_JAVA2.seq_doctor_pk.nextval),'Goshen, Litchfield County, Connecticut, 06756, United States',to_date('29-JUL-72','DD-MON-RR'),0,'Jamie Alexis McMullen','5704787708',null);
Insert into VN_JAVA2.DOCTOR (ID,ADDRESS,DATE_OF_BIRTH,GENDER,NAME,PHONE_NUMBER,DEPARTMENT_ID) values ((VN_JAVA2.seq_doctor_pk.nextval),'Macaná, Guayanilla, Peñuelas, Puerto Rico, 00624, United States',to_date('30-OCT-64','DD-MON-RR'),1,'Jody Ayers','3525869106',null);
Insert into VN_JAVA2.DOCTOR (ID,ADDRESS,DATE_OF_BIRTH,GENDER,NAME,PHONE_NUMBER,DEPARTMENT_ID) values ((VN_JAVA2.seq_doctor_pk.nextval),'Plumas County, California, United States',to_date('26-NOV-60','DD-MON-RR'),0,'Gilberto Sargent','7125685338',null);
